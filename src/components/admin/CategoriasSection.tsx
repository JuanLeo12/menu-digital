      ...
      {categorias.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categorias.map((c) => (
            <div
              key={c.id}
              className="flex flex-col items-start p-4 rounded-2xl bg-white border border-slate-200 shadow-sm gap-3"
            >
              ...
              <div className="flex items-center gap-2 w-full">
                <button
                  ...
                  className="flex-1 justify-center bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-700 p-2.5 rounded-xl transition-colors flex items-center gap-2 shadow-sm"
                >
                  <Edit2 size={16} />
                ...
                <button
                  ...
                  className="flex-1 justify-center bg-slate-50 border border-slate-200 hover:bg-red-50 text-red-500 p-2.5 rounded-xl transition-colors flex items-center gap-2 shadow-sm"
                >
                  <Trash2 size={16} />
